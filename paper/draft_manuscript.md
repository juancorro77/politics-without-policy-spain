# Auditoría de Sesiones del Congreso: Cuantificación del Desplazamiento de Agenda (ASR) y Evasión (ER)
...
| :--- | :---: | :---: | :---: |
| **Iniciativas sobre Policy (Gestión) Registradas** | 254 | 142 | - |
| **Iniciativas sobre Politics (Poder) Registradas** | 1083 | 965 | - |
| **Tasa de Desplazamiento de Agenda (ASR) Media** | 69.0% | 71.2% | ▲ Incremento |
| **Tasa de Evasión del Gobierno (ER) Media** | 69.8% | 68.9% | ▼ Descenso |

> [!IMPORTANT]
> **Hallazgo Clave**: En la XV Legislatura, el **71.2%** del tiempo dedicado a debatir preguntas de gestión ciudadana (vivienda, energía, transporte, etc.) se consume en discusiones partidistas sobre el poder, amnistías, vetos o corrupción partidista. Asimismo, los ministros evaden la respuesta técnica dedicando el **68.9%** de su tiempo a contraatacar en clave partidista, evitando rendir cuentas de su cartera.
